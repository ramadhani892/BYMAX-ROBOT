...
buttons = [
    [
        InlineKeyboardButton(text="About Bymaxx Robot", callback_data="emiko_"),
    ],
    [
        InlineKeyboardButton(text="Dapatkan Help", callback_data="help_back"),
...
def emiko_about_callback(update, context):
    ...
    if query.data == "emiko_":
        query.message.edit_text(
            text="๏ I'm *Bymaxx*, a powerful group management bot built to help you manage your group easily."
            ...
            "\n\n_Bymaxx licensed under the GNU General Public License v3.0_"
            "\n\n Click on button bellow to get basic help for BymaxxRobot.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
        ...
        query.message.edit_text(
            ...
            "\nCongragulations, Bymaxx Robot now ready to manage your group."
            "\n\n*Admin Tools*"
